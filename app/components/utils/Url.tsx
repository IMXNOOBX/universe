    ...
    return (
        <>
            <Link
                ...
                className={`group flex gap-2 justify-center ml-1
            ...
            >
                <span className={children ? `bg-left-bottom bg-gradient-to-r rounded-md from-indigo-500/70 to-indigo-500/70 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out` : ''}>
                    {children || domain}
                </span>
