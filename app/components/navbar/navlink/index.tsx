                    ...
                    <Image 
                        ...
                        className={
                            `select-none w-8 transition-all duration-300 border-opacity-0 border-indigo-500 rounded-xl ${ isActive ? 
                                    ...
                                    : 'rotate-45 group-hover:rotate-0 group-hover:shadow-[#5D5DFF_0px_0px_30px] group-hover:bg-indigo-500/50 group-hover:border-2 group-hover:border-opacity-100  group-hover:p-1 group-hover:translate-y-3'
                                }`
                            } 
                            alt="icon" 
                    />
                    <div 
                        className={`flex absolute my-auto transition-all duration-300 w-0 opacity-0 font-semibold justify-center whitespace-nowrap ${ isActive ? 
                            'text-base w-full opacity-100 -translate-y-4 translate-x-0' 
                                : 'text-xs translate-x-3 group-hover:text-base group-hover:w-full group-hover:opacity-100 group-hover:-translate-y-4 group-hover:translate-x-0'
                            } `}>
                        {children}
                    </div>
                </div>
